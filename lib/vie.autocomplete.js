      ...
      return this.element.autocomplete({
        ...
        open: function(e, ui) {
          ...
          if (widget.options.showTooltip) {
            uiMenu = ((_ref = $(this).data().autocomplete) != null ? _ref.menu : void 0) || $(this).data().uiAutocomplete.menu;
            return $('.ui-menu-item', uiMenu.activeMenu).each(function() {
              var item, uri;
        ...
        select: function(e, ui) {
          ...
          uiMenu = ((_ref = $(e.target).data().autocomplete) != null ? _ref.menu : void 0) || $(e.target).data().uiAutocomplete.menu;
